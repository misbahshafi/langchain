"""
AI-Powered Daily Journal Assistant - Web Application
A Flask-based web interface with direct OpenAI API integration
"""
...
def initialize_components():
    ...
    # Check AI availability (skip connection test to avoid blocking)
    if Config.OPENAI_API_KEY:
        ai_available = True
        print("✅ AI features enabled (API key found)")
        print("⚠️  Note: AI features will be tested when first used")
    else:
        print("⚠️  AI features disabled: No API key found")
...
def analyze_entry_with_ai(content):
    ...
    # Mood analysis
    mood_prompt = f"""Analyze the mood of this journal entry and respond with ONLY a JSON object:
    {{
...
def new_entry():
    """New entry form"""
    return render_template('new_entry.html', ai_available=ai_available)
...
if __name__ == '__main__':
    print("🚀 Starting AI-Powered Daily Journal Assistant...")
