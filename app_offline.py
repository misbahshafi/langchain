"""
Daily Journal Assistant - Offline Web Application
A Flask-based web interface that works without AI features
"""
...
def chat_message():
    ...
    return jsonify({'success': False, 'error': 'AI chat not available in offline mode'})
